...
for i in $(seq 1 $EXECUTIONS); do
    ...
    xvfb-run pnpm jest --reporters=default --reporters=jest-junit --runInBand --detectOpenHandles --forceExit test/integration/
    mv "./junit.xml" "/test-results/results_$i.xml"
